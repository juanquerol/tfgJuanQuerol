<template>
  ...
  <div class="comment-container" v-for="(comentario, index) in comentarios" :key="index">
    ...
    <div class="comment-likes">
      ...
      <!-- ideas populares guiandose con el numero de likes -->
      <div class="column is-full">
    <h1 class="title has-text-centered">Populares</h1>
  </div>
      <div class="column is-one-third" v-for="(idea, index) in ideas.sort((a, b) => b.Likes - a.Likes)" :key="index" @click="selectIdea(idea)">
        <div class="card idea">
          <div class="card-content">
            <div class="content">
              <div class="columns is-vcentered">
